...
@section('content')
<section class="py-12">
    <h2 class="text-4xl font-extrabold text-center mb-12 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-clip-text text-transparent">
        Our Service Plans
    </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-4">
        ...
        <div class="bg-white rounded-2xl shadow-xl border-t-4 border-gray-400 p-6 hover:scale-105 transition">
            <h3 class="text-2xl font-bold text-gray-700 mb-4">Silver Plan</h3>
            <p class="text-gray-600 mb-4">Ideal for students who want guidance at every step but will handle execution themselves.</p>
            <ul class="list-disc pl-5 space-y-2 text-gray-600 text-base">
                ...
                <li><span class="line-through">No editing/writing of documents</span></li>
                <li><span class="line-through">No document attestation</span></li>
            </ul>
        </div>

        <!-- Gold Plan -->
        <div class="bg-white rounded-2xl shadow-xl border-t-4 border-yellow-400 p-6 hover:scale-105 transition">
            <h3 class="text-2xl font-bold text-yellow-600 mb-4">Gold Plan</h3>
            <p class="text-gray-600 mb-4">Perfect if you want professionally written documents — ready to impress universities.</p>
            <ul class="list-disc pl-5 space-y-2 text-gray-600 text-base">
        ...
        <div class="bg-white rounded-2xl shadow-xl border-t-4 border-pink-500 p-6 hover:scale-105 transition">
            <h3 class="text-2xl font-bold text-pink-600 mb-4">Diamond Plan</h3>
            <p class="text-gray-600 mb-4">VIP plan: Just submit your data — we’ll handle everything, including attestation.</p>
            <ul class="list-disc pl-5 space-y-2 text-gray-600 text-base">
