...
<section class="py-12 max-w-5xl mx-auto px-4">
    <h2 class="text-4xl font-extrabold text-center mb-10 bg-gradient-to-r from-green-400 via-blue-400 to-purple-500 bg-clip-text text-transparent">
        Mandatory Documents
    </h2>

    <!-- Admission Documents -->
    <div class="bg-white rounded-2xl shadow-md border-l-4 border-blue-500 p-6 mb-10">
        <h3 class="text-2xl font-bold text-blue-600 mb-4">📘 For Admission</h3>
    ...
    <!-- Visa Documents -->
    <div class="bg-white rounded-2xl shadow-md border-l-4 border-pink-500 p-6">
        <h3 class="text-2xl font-bold text-pink-600 mb-4">🛂 For Visa</h3>
        <p class="text-gray-700 mb-4">
